...
public class PelmenKingAnimations {
    public static final AnimationDefinition ANIM_PELMEN_KING_UNIVERSAL = AnimationDefinition.Builder.withLength(4.0F).looping()
            .addAnimation("pelmen", new AnimationChannel(AnimationChannel.Targets.POSITION,
